...
const { product_return_schema, product_return_list_schema, product_return_details_schema } = require("./schema");
const save_product_return = require("./controller/save-product-return");
...
router.post(
      ROUTES.SAVE_PRODUCT_RETURN,
      [jwtMiddleware, validator.post(product_return_schema)],
      save_product_return
);
